...
#         if rank_description:
#             if rank_description.group(1):
#                 job_rank = rank_description.group(1)
#     return job_rank
#     stream.close()

#
#
# print(read_url_pay_rank('https://cs1110.cs.virginia.edu/files/uva2018/james-e-ryan'))
